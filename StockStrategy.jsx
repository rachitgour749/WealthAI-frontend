...
const nifty50Stocks = [
  ...
  { value: 'WIPRO', label: 'Wipro Ltd.' },{ value: 'ADANIENT', label: 'Adani Enterprises Ltd.' },
...
function StockStrategy({ onBack }) {
  ...
  const loadSavedStrategy = (strategy) => {
    ...
    try {
      ...
      setStrategyLoadedMessage(`Strategy "${strategy.strategy_name || strategy.name || 'Stock Strategy'}" loaded successfully!`);
                            ...
                            <div className="flex-1">
                              ...
                              {strategy.tickers && Array.isArray(strategy.tickers) && (
                                <p className="text-xs text-gray-500 mt-1">
                                  {strategy.tickers.length} stocks selected
                                </p>
                              )}
                            </div>
