...
const ProfilePage = ({ setCurrentPage, currentPage, hideHeaderFooter = false }) => {
  ...
  return (
    <div className="border-3 border-black h-[400px] w-[400px]">
...
//       className="inline-flex items-center px-4 py-2 bg-white/80 backdrop-blur-sm border border-gray-200 rounded-lg shadow-md hover:bg-white hover:shadow-lg transition-all duration-300 transform hover:scale-105 text-gray-700 font-medium"
//     >
...
//       <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2 relative z-10">
//         {/* Card Header with 3D Effect */}
//         <div className="relative p-8 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-t-3xl overflow-hidden">
