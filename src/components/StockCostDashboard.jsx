...
const StockCostsDashboard = () => {
  ...
  const loadCostsData = async () => {
    try {
      ...
      // Load costs summary
      const summaryResponse = await axios.get(`${API_BASE_URL}/api/stocks/costs/summary`);
      ...
      const analysisResponse = await axios.get(`${API_BASE_URL}/api/stocks/costs/analysis`);
      ...
      const breakdownResponse = await axios.get(`${API_BASE_URL}/api/stocks/costs/breakdown`);
...
export default StockCostsDashboard;
