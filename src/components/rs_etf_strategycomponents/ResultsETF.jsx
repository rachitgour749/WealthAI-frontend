...
const ResultsETF = ({ onSelectResult, onBackToSetup, isBacktestRunning = false }) => {
  const { user } = useAuth();
  ...
  const saveStrategyParameters = async (customName) => {
    ...
    try {
      ...
      // Get strategy config to extract etf_universe
      ...
      const strategyParams = {
        ...
        etf_universe: strategyConfig?.etf_universe || "ALL_ETFS", // ETF universe
        backtest_results: {
  ...
  const handleDeleteStrategy = async (strategy) => {
    try {
      const response = await axios.delete(`/api/delete-rs-etf-strategy/${strategy.id}`);
                      ...
                      savedStrategies.map((strategy) => (
                        <tr key={strategy.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            {strategy.etf_universe || 'ALL_ETFS'}
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <div><span className="font-medium">ETF Universe:</span> {selectedStrategyDetails?.etf_universe}</div>
              ...
              {selectedStrategyDetails?.strategy_config && (
                <div className="mt-6 bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div><span className="font-medium">ETF Universe:</span> {selectedStrategyDetails.strategy_config.etf_universe}</div>
                  </div>
                </div>
              )}
