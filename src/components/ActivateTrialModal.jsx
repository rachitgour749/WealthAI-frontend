...
const ActivateTrialModal = ({ 
  ...
  const { activateProductTrial } = useSubscription();
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full animate-in zoom-in-95 duration-300">
        ...
        <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-green-500 to-blue-600">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-white">Activate Trial</h2>
            <button
              onClick={onClose}
        ...
        <div className="p-6">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">
              Start your free trial and get access to all products for 7 days.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              <li className="flex items-center">
                ...
                Access to MarketsAI1, ChatAI1, TradeAI1, and AutomationAI
              </li>
              <li className="flex items-center">
                <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                </svg>
                7 days of free usage
              </li>
              <li className="flex items-center">
                <svg className="w-4 h-4 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
